...
class Session(Base):
    ...
    session_type: Mapped[SessionType] = mapped_column(
        Enum(SessionType), default=SessionType.practice
    )
    ...
    track: Mapped["Track"] = relationship(back_populates="sessions")  # noqa: F821
    car: Mapped["Car"] = relationship(back_populates="sessions")  # noqa: F821
    laps: Mapped[list["Lap"]] = relationship(back_populates="session")  # noqa: F821
